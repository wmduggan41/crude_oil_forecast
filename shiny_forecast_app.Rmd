...
observeEvent(input$submit_button, {
    ...
    prediction_mae_tbl <- predictions_tsbl %>%
        ...
        group_by(.model) %>%
        summarize(mae = mean(abs(price_wti - .pred))) %>%
    ...
    #     refit(us_petroleum_prep_m_tsbl)
...
div(
    ...
    div(
        class = "col-md-3",
        info_card(title = "Some Title", value = "20%", sub_value = "300",
                  main_icon = "chart-line", sub_icon = "arrow-up", 
                  bg_color = "default")
    )
)
...
div(
    ...
    div(
        ...
        div(
            class = "panel",
            div(class = "panel-heading", h5("Original Series")),
